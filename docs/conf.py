...
#
from formulae import __version__
...
html_logo = "logo/formulae_small.png"
...
latex_documents = [
    (master_doc, "formulae.tex", "Formulae Documentation", "The developers of Bambi", "manual"),
]
...
man_pages = [(master_doc, "formulae", "Formulae Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "bambi",
        "Statistical model formulas in Python",
        "Miscellaneous",
    ),
]
