...
class TestThinPlateRegressionSpline:
    ...
    def test_shape_centering_and_null_space(self, sequence):
    ...
    def test_uncentered_null_space(self, sequence):
        ...
        assert np.allclose(null_basis, expected)
        assert basis[:, spline.null_space_dimension :].shape == (21, 3)
    ...
    def test_through_design_matrices_and_new_data(self, sequence):
        ...
        assert transform.null_space_dimension == new_transform.null_space_dimension == 1
